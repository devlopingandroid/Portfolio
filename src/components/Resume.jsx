  ...
  const timelineItem = (title, period, subtitle, points) => (
    <div style={{ display: 'flex', gap: '20px', marginBottom: '32px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ width: '2px', flex: 1, background: 'rgba(0,212,170,0.2)', marginTop: '6px' }} />
      </div>
      <div style={{ paddingBottom: '8px' }}>
        <h4 style={{ color: 'white', fontWeight: 700, fontSize: '0.9rem', letterSpacing: '0.5px', marginBottom: '4px' }}>{title}</h4>
        <span style={{ color: '#00d4aa', fontSize: '0.82rem', fontWeight: 600 }}>{period}</span>
        {subtitle && <p style={{ color: '#aaa', fontStyle: 'italic', fontSize: '0.85rem', margin: '4px 0 8px' }}>{subtitle}</p>}
        {points && (
          <ul style={{ margin: 0, paddingLeft: '18px' }}>
            {points.map((p, i) => (
              <li key={i} style={{ color: '#ccc', fontSize: '0.88rem', marginBottom: '4px', lineHeight: 1.6 }}>{p}</li>
            ))}
          </ul>
        )}
      </div>
  ...
  return (
    <section id="resume" className="section-container">
      ...
      >
        ...
        <p style={{ color: '#aaa', marginBottom: '48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 60px' }}>
          ...
          <div>
            <h3 style={{ color: 'white', fontSize: '1.3rem', marginBottom: '24px', borderBottom: '2px solid #00d4aa', paddingBottom: '8px' }}>Summary</h3>
            ...
            <h3 style={{ color: 'white', fontSize: '1.3rem', margin: '8px 0 24px', borderBottom: '2px solid #00d4aa', paddingBottom: '8px' }}>Education</h3>
            ...
            <h3 style={{ color: 'white', fontSize: '1.3rem', margin: '8px 0 24px', borderBottom: '2px solid #00d4aa', paddingBottom: '8px' }}>Achievements</h3>
          ...
          <div>
            <h3 style={{ color: 'white', fontSize: '1.3rem', marginBottom: '24px', borderBottom: '2px solid #00d4aa', paddingBottom: '8px' }}>Experience</h3>
            ...
            <h3 style={{ color: 'white', fontSize: '1.3rem', margin: '8px 0 24px', borderBottom: '2px solid #00d4aa', paddingBottom: '8px' }}>Research & Patents</h3>
